...
select_data = st.selectbox("Select data to view", data_choice, placeholder="What data you want to see?")
st.title(f"{select_data} for the next {forecast_days} day/s in {place}")
